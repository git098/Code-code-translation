...
def main(args):
    ...
    # If using the debug directory, force percentage to 100% to use the whole debug set
    if 'data/debug' in args.data_dir:
        print("Debug mode detected. Forcing data percentage to 100%.")
        args.percentage = 1.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="Salesforce/codet5-base", help="Name of the base model to use.")
